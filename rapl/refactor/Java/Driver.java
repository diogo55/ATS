...
public class Driver extends User implements Serializable {
     ...
     */
    public Driver(String email, String name, String password, String address, LocalDate birthday, double totalDistance, double rating, Boolean availability, double timeCompliance, ArrayList<Trip> trips, int numberOfReviews, double money,String vehicle, String company, double deviation){
