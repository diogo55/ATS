...
public class EnergyCheckUtils {
	...
	public static void main(String[] args) {
		...
		System.out.println("Resultado: " + (media2[0]/10)+ "joules of DRAM energy");

		System.out.println("Resultado: " + (media2[1]/10)+ "joules of CPU energy");

		System.out.println("Resultado: " + (media2[2]/10)+ "joules of Package energy");
