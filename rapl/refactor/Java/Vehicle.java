...
public abstract class Vehicle implements Serializable {
     ...
     */
    public Vehicle(String licencePlate, double reliable, Point2D.Double position, LinkedList<String> queue, HashMap<String, ArrayList<Point2D.Double>> queueInfo, ArrayList<Trip> trips, String owner){
