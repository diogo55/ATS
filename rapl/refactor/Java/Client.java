...
public class Client extends User implements Serializable {
     ...
     */
    public Client(String email, String name, String password, String address, LocalDate birthday, Point2D.Double position, double totalDistance, ArrayList<Trip> trips, int points, double money, boolean premium) {
