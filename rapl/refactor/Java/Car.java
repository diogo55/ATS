...
public class Car extends Vehicle implements Serializable {
    ...
    public Car(String licencePlate, double reliable, Point2D.Double position, String owner) {
        super(licencePlate, reliable, position, null, null, null, owner);
        this.setSpeed(65);
        this.setPrice(1.5);
        this.setSeats(4);
    }
     ...
     */
    public Car(Car v) {
        super(v.getLicencePlate(), v.getReliable(), v.getPosition(), v.getQueue(), v.getQueueInfo(), v.getTrips(), v.getOwner());
        this.setSpeed(65);
        this.setPrice(1.5);
        this.setSeats(4);
    }
