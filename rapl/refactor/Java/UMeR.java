...
public class UMeR implements Serializable {
    ...
    public HashMap<String, Driver> getDriversP() {
        ...
        for (Driver driver : this.driversP.values()) {
            newDrivers.put(driver.getEmail(), driver.clone());
        }
        return newDrivers;
    }
    ...
    public HashMap<String, Client> getClients() {
        ...
        for (Client client : this.clients.values()) {
            map.put(client.getEmail(), client.clone());
        }
        return map;
    }
    ...
    public HashMap<String, Vehicle> getVehiclesP() {
        ...
        for (Vehicle vehicle : this.vehiclesP.values()) {
            map.put(vehicle.getLicencePlate(), vehicle.clone());
        }
        return map;
    }
    ...
    public HashMap<String, Driver> getAllDrivers(){
        ...
        for (Driver driver : this.allDrivers.values()) {
            map.put(driver.getEmail(), driver.clone());
        }
        return map;
    }
    ...
    public HashMap<String, Company> getCompanies() {
        ...
        for (Company company : this.companies.values()) {
            map.put(company.getName(), company.clone());
        }
        return map;
    }
    ...
    public HashMap<String, User> allUsers(){
        ...
        for (Driver driver1 : this.driversP.values()) {
            allUsers.put(driver1.getEmail(), driver1.clone());
        }
        for (Company company : this.companies.values()) {
    ...
    public String closestAvailableTaxi(Client client){
        ...
        for (Vehicle vehicle : this.allVehicles.values()){
            if (vehicle.isAvailable() &&
                    (companies.get(vehicle.getOwner()) == null || companies.get(vehicle.getOwner()).availiableTaxis()) &&
                            vehicle.getPosition().distance(client.getPosition()) < min) {
