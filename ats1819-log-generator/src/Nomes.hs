...
listaCompanhias :: [String]
listaCompanhias = 
  ["Talk Taxi","Grilo Taxi","Comando Taxi","Out Taxi","Primavera Taxi"
  ,"Taxi Cidade", "Taxi Suco","Taxi Worth","Geek Taxi","Razor Taxi","Taxi Independente"
  ,"Redwood Taxi","Motor Taxi","Taxi Parceiro","Taxi e Amigos","Taxi Lideres","Taxi Rapido"
  ,"Taxi Grupos","Roadrunner Taxi","Sr Taxi"
  ]
